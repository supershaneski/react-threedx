...
var gTDXWallAlpha = 0.4;
var gTDXFloorAlpha = 0.2; //0.2;
...
function tdx_InitProperties() {
  ...
  var tdx = document.getElementById("Control1");
	tdx.SetProperty("PutOnFloor", "true");
  tdx.SetProperty("TatamiSize", String(gDefaultTatamiSize));
	tdx.SetProperty("UsePlayedAnim", "true");
	tdx.RenderingHint = gTDXRenderingHint;
  ...
  var tdx = document.getElementById("Control1");
    ...
    setTimeout(function(){
      ...
      //my.namespace.pubOn3dxEvent(JSON.stringify(param));
		...
		if(tdx.MessageBox("削除","選択したオブジェクトを消去しますか？",4)){
      tdx.DeleteObject();
      setTimeout(function(){
        var param = {
          event:'OnDelete',
